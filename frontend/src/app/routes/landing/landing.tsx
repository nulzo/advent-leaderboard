    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground">
      <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-12">
        ...
        <motion.div 
          ...
          className="lg:col-span-8 flex flex-col justify-center p-6 sm:p-8 md:p-12 lg:p-24 lg:border-r border-border"
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-bold tracking-tighter leading-[0.85] mb-6 md:mb-8 uppercase">
            Advent<br />
            Of Code<br />
          ...
          <div className="max-w-xl space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <Button 
                size="lg" 
                onClick={handleStart}
                className="text-base md:text-lg h-12 md:h-14 px-6 md:px-8 bg-foreground text-background hover:bg-foreground/90"
              >
                Enter Dashboard <ArrowRight className="ml-2 h-4 w-4 md:h-5 md:w-5" />
              </Button>
              ...
              >
                <Button 
                  variant="outline" 
                  size="lg"
                  className="text-base md:text-lg h-12 md:h-14 px-6 md:px-8 w-full"
                >
        ...
        <div className="hidden lg:flex lg:col-span-4 bg-muted/30 relative overflow-hidden items-center justify-center">
          ...
          <motion.div
            ...
            className="relative w-48 xl:w-64 h-48 xl:h-64 border border-foreground rounded-full flex items-center justify-center"
          >
             <div className="w-24 xl:w-32 h-24 xl:h-32 bg-foreground rounded-full" />
          </motion.div>
        </div>
      </div>
    </div>
